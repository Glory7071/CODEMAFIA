 const motives = [
  ...
  { q: "Which of the following scheduling algorithms can lead to starvation?", o: ["A)FCFS", "B)Round Robin", "C)Shortest Job First", "D)None"], a: 2 },
  { q: "What is the time complexity of searching an element in a Hash Table (Average Case)?", o: ["A) O(1)", "BO) (log n)", "C) O(n)", "D) O(n^2)"], a: 0 },
  { q: "A process that has finished execution but still has an entry in the process table is called?", o: ["A)Orphan Process", "B)Zombie Process", "C)Parent Process", "D)Daemon Process"], a: 1 },
  { q: "Which logic gate is equivalent to (A+B)'?", o: ["A)NAND", "B)NOR", "C)XOR", "D)XNOR"], a: 1 },
  { q: "Which data structure is used to implement recursion?", o: ["A)Queue", "B)Stack", "C)Linked List", "D)Tree"], a: 1 },
  { q: "In Digital Logic, 16-to-1 Multiplexer has how many select lines?", o: ["A)2", "B)3", "C)4", "D)5"], a: 2 },
  { q: "Banker's Algorithm is used for?", o: ["A)Deadlock Prevention", "B)Deadlock Avoidance", "C)Deadlock Detection", "D)Resource Allocation"], a: 1 },
  { q: "What is the result of 2's complement of 1100?", o: ["A)0100", "B)0011", "C)0010", "D)1111"], a: 0 },
  { q: "Which sorting algorithm has the best worst-case time complexity?", o: ["A)Bubble Sort", "B)Insertion Sort", "C)Merge Sort", "D)Selection Sort"], a: 2 },
  { q: "In OS, 'Paging' is used to solve which problem?", o: ["A)Internal Fragmentation", "B)External Fragmentation", "C)Thrashing", "D)Starvation"], a: 1 },
    // --- Set 7: Operating Systems (Linux/Unix Internals & Advanced Concepts) ---
    { q: "Which Linux/Unix command is used to display the currently running processes?", o: ["A) ls", "B) grep", "C) ps", "D) kill"], a: 2 },
    { q: "In the Unix/Linux file system structure, what does an 'inode' contain?", o: ["A) Actual file data", "B) File name and path", "C) Metadata like permissions, ownership, and block pointers", "D) User password"], a: 2 },
    { q: "The 'fork()' system call creates a new process that is an exact copy of the parent process, except for which unique identifier?", o: ["A) File pointers", "B) Process ID (PID)", "C) Memory layout", "D) User ID (UID)"], a: 1 },
    { q: "What is 'Aging' a technique used to prevent in Priority Scheduling algorithms?", o: ["D) Deadlock", "C) Starvation", "B) Context switching overhead", "D) Convoy effect"], a: 1 },
    { q: "Which memory allocation technique suffers from 'External Fragmentation'?", o: ["A) Paging", "B) Segmentation", "C) Fixed Partitioning", "D) Virtual Memory"], a: 1 },
    { q: "Which protection ring in a CPU (e.g., x86 architecture) is reserved for the Operating System Kernel with full privileges?", o: ["A) Ring 3 (User Space)", "B) Ring 2", "C) Ring 1", "D) Ring 0 (Kernel Space)"], a: 3 },
    { q: "Which algorithm is used by Linux for scheduling interactive processes, providing dynamic priorities?", o: ["A) FCFS", "B) CFS (Completely Fair Scheduler)", "C) Round Robin", "D) SJF"], a: 1 },
    { q: "What is the result of using a 'Monitor' for synchronization?", o: ["A) Guarantees no deadlocks", "B) Ensures only one process is active within the critical section code at any time", "C) Increases thrashing", "D) Eliminates starvation"], a: 1 },
    { q: "In virtual memory systems, a 'Page Fault Rate' is used to control which condition?", o: ["A)CPU utilization", "B) Throughput", "C) Thrashing", "D) Disk access time"], a: 2 },
    { q: "Which layer of the OS kernel directly interacts with the hardware devices?", o: ["A) Application Layer", "B) System Call Interface", "C) Hardware Abstraction Layer (HAL) / Device Drivers", "D) Shell"], a: 2 },
