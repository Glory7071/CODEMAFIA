    ...
    function updateCountdown() {
        ...
        const startDate = new Date("2025-11-22T19:00:00+05:30").getTime(); // रजिस्ट्रेशन शुरू
        ...
        if (now < startDate) {
            ...
            if(countdown) countdown.innerHTML = `⏳ Registration <strong>November 22th at 7 PM</strong> से शुरू होगा (लगभग <strong>${String(hrsLeft).padStart(2,'0')}</strong> घंटे <strong>${String(minsLeft).padStart(2,'0')}</strong> मिनट बाकी)`;
        ...
        if(countdown) countdown.innerHTML =
            `रजिस्ट्रेशन बंद होने में: <strong>${String(days).padStart(2,'0')}</strong> दिन <strong>${String(hours).padStart(2,'0')}</strong> घंटे <strong>${String(minutes).padStart(2,'0')}</strong> मिनट`;
